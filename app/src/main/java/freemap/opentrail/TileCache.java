...
// NW 15/01/18 added functionality to delete all tiles
...
public class TileCache implements ITileCache {
    ...
    private final SQLiteStatement mStmtDeleteTiles;
    ...
    public TileCache(Context context, String cacheDirectory, String dbName) {
        ...
        mStmtDeleteTiles = mDatabase.compileStatement("DELETE FROM " + TABLE_NAME);
